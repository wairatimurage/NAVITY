...
export const InstagramSvg = () => {
  const instagram = `<svg version="1.1" id="Layer_1" height="3rem" width="3rem" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<path class="st14" d="M15.1,88.2c0,0,2.7-70.7,80.4-68.4s208.6-0.8,221.7,76.6c13.1,77.4-84.3,222.8-162.9,222.6
 C86.5,318.8,10.9,193.2,15.1,88.2z"/>
<g>
 <g>
   <path class="st12" d="M166.7,98.5c-27.7,0-50.2,22.5-50.2,50.2c0,27.7,22.5,50.2,50.2,50.2c27.7,0,50.2-22.5,50.2-50.2
     C216.9,120.9,194.4,98.5,166.7,98.5L166.7,98.5z M166.7,181.2c-18,0-32.6-14.6-32.6-32.6s14.6-32.6,32.6-32.6s32.6,14.6,32.6,32.6
     C199.3,166.6,184.7,181.2,166.7,181.2z"/>
   <path class="st12" d="M207,51.5c-18-0.8-62.5-0.8-80.6,0c-15.8,0.7-29.8,4.6-41,15.8C66.6,86.1,69,111.5,69,148.6
     c0,38-2.1,62.8,16.4,81.3c18.9,18.9,44.6,16.4,81.3,16.4c37.7,0,50.7,0,64-5.1c18.1-7,31.8-23.2,33.1-52.3c0.8-18,0.8-62.5,0-80.6
     C262.2,74,243.8,53.2,207,51.5L207,51.5z M235.5,217.5c-12.3,12.3-29.4,11.2-69,11.2c-40.7,0-57.1,0.6-69-11.3
     c-13.7-13.7-11.2-35.6-11.2-68.9c0-45-4.6-77.4,40.6-79.7c10.4-0.4,13.4-0.5,39.6-0.5l0.4,0.2c43.4,0,77.5-4.5,79.5,40.6
     c0.5,10.3,0.6,13.4,0.6,39.5C246.8,188.9,247.6,205.3,235.5,217.5L235.5,217.5z"/>
   <circle class="st12" cx="218.9" cy="96.5" r="11.7"/>
 </g>
</g>
</svg>
`;
  return (
    <div dangerouslySetInnerHTML={{ __html: instagram }} className=""></div>
  );
};

export const LinkedInSvg = () => {
  const linkedIn = `<svg version="1.1" height="3rem" width="3rem" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  viewBox="0 0 333.4 333.4" style="enable-background:new 0 0 333.4 333.4;" xml:space="preserve">
<style type="text/css">
 .st0{fill:none;stroke:#486EB4;stroke-width:15;stroke-miterlimit:10;}
 .st1{fill:none;stroke:#B54185;stroke-width:15;stroke-miterlimit:10;}
...
<path class="st17" d="M15.1,88.2c0,0,2.7-70.7,80.4-68.4s208.6-0.8,221.7,76.6c13.1,77.4-84.3,222.8-162.9,222.6
 C86.5,318.8,10.9,193.2,15.1,88.2z"/>
<g>
 <g>
   <path class="st12" d="M253.8,223.8L253.8,223.8L253.8,223.8l0-63.9c0-31.3-6.7-55.4-43.3-55.4c-17.6,0-29.4,9.6-34.2,18.8h-0.5
     v-15.9h-34.7v116.4h36.1v-57.6c0-15.2,2.9-29.8,21.7-29.8c18.5,0,18.8,17.3,18.8,30.8v56.7L253.8,223.8z"/>
   <path class="st12" d="M82.4,107.5h36.1v116.4H82.4V107.5z"/>
   <path class="st12" d="M100.5,49.5c-11.6,0-20.9,9.4-20.9,20.9s9.4,21.1,20.9,21.1s20.9-9.6,20.9-21.1
     C121.4,58.9,112,49.5,100.5,49.5z"/>
 </g>
</g>
</svg>
`;
  return (
    <div dangerouslySetInnerHTML={{ __html: linkedIn }} className=""></div>
  );
};

export const TwitterSvg = () => {
  const twitter = `<svg version="1.1" id="Layer_1" height="3rem" width="3rem" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  viewBox="0 0 333.4 333.4" style="enable-background:new 0 0 333.4 333.4;" xml:space="preserve">
<style type="text/css">
 .st0{fill:none;stroke:#486EB4;stroke-width:15;stroke-miterlimit:10;}
 .st1{fill:none;stroke:#B54185;stroke-width:15;stroke-miterlimit:10;}
...
`;
  return <div dangerouslySetInnerHTML={{ __html: twitter }} className=""></div>;
};
